# =============================================================
# Nombre del archivo: descargar_datos_csv.py
# Autor: Grant Nathaniel Keegan
# Descripción: Para obtener las cartas de MTG en formato standard.
#   El archivo de output es una tabla CSV con todas las cartas.
...
def get_standard_cards():
    """
    Descarga todas las cartas legales en Standard de Scryfall (de los últimos 3 años aprox)
    y las guarda un CSV con los atributos de la elección del usuario.
    """
    ...
    while next_page:
        ...
        # Paginación para dividir la descarga de las cartas.
...
if __name__ == "__main__":
    ...
    print(df.head()) # Mostramos el dataframe con Pandas para confirmar la descarga.